...
For this I created in a first step ideal Bravais lattices, to which i added random (gaussian) noise, and defects (meaning a removal of a random number of nodes at random positions). 
...
For the 3D lattices a  size of 10 times 10 times 10 nodes has been tried but deemed unpractical as the time effort for training is quite large. 
...
Instead the focus shifts towards a new goal, namely the detection of defects in monoatomic crystals. 
...
During the same time I want to gain familiarity with the theory and suitable approaches to defect detection by reading literature and starting the first coding experiments. 
